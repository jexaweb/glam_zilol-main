...
function About() {
  ...
  const translations = {
    ...
    ru: {
      title: "ДОБРО ПОЖАЛОВАТЬ В КОМПАНИЮ ПО МОЙКЕ КОВРОВ ZILOL!",
      desc: "Мы предоставляем высококачественные услуги уже 8 лет. Качество, надежность и скорость — наши главные ценности.",
      aboutTitle: "Почему выбирают нас?",
      aboutText: [
        "За более чем 8 лет работы мы заслужили доверие более 150 000 клиентов.",
        "Мы сотрудничаем с ведущими организациями.",
        "Мы обеспечиваем бесперебойное обслуживание в течение всего года.",
        "Мы используем экологически чистые и безопасные инструменты.",
      ],
      list: [
