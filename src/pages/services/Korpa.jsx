...
export default function Korpa() {
  ...
  const t = {
    uz: {
      ...
      list: [
        "✔ paxtali ko‘rpa yuvish",
        "✔ Tez va sifatli xizmat",
        "✔ Uydan olib ketish va qaytarish",
      ],
  ...
  transition-all duration-300 shadow-md hover:scale-110 active:scale-95"
      ...
      <section className="relative py-20 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">{t.cta}</h2>

          <p className="mb-8 text-lg text-gray-300">{t.discount}</p>
